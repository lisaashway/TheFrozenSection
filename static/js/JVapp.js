...
const groceryURL = "/static/data/all_georgia.json";
...
// def incURL
const incURL = "/static/data/Income_(by_Zip_Code)_2018.csv";

// def educURL
const educURL = "/static/data/Educational_Attainment_(by_Zip_Code)_2018.csv";
...
d3.csv(educURL).then(function(education){
    ...
    dropdown.on("change", function() {
        ...
        d3.json(groceryURL, function(zipcodes){
            console.log(zipcodes[selectedZIP].groceryStores)
            var grocerylist = zipcodes[selectedZIP].groceryStores;
